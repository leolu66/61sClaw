...
description: AI 新闻聚合与热度排序工具。当用户使用以下关键词时触发："多维采集AI新闻"、"综合查询AI新闻"、"多维度AI新闻"、"全球AI热点"、"AI圈最近讨论热点"、"最近火的AI产品"。覆盖：新产品发布、研究论文、行业动态、融资新闻、开源项目更新、社区病毒传播现象、AI 工具/Agent 热门项目。输出中文摘要列表，按热度排序，附带原文链接。
---
