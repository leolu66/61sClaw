...
def run_lifetime_card_task() -> bool:
    ...
    try:
        ...
        playcard_radius = playcard_btn.get('radius', 40)
        ...
        lifetime_y = lifetime_btn.get('screen_y', 1455)
        ...
        # 步骤9：关闭成功领取提示框（在领取按钮位置点击）
        print("\n[步骤9] 关闭成功领取提示框...", flush=True)
