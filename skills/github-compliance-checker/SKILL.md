...
- ~~原白名单目录 `docs/`, `.github/`, `backups/`, `.clawhub/`, `.learnings/`, `config/` 已移除~~，禁止同步到GitHub
...
# 示例
python scripts/compliance_checker.py allow ".github/" "GitHub工作流配置，需要同步"
python scripts/compliance_checker.py deny "test/" "测试目录，不需要同步"
