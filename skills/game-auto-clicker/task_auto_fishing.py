...
def run_auto_fishing_task() -> bool:
    ...
    fishing_size = fishing_btn.get('size', 80)  # 80x80正方形
    
    print("\n[步骤4] 点击钓鱼按钮...", flush=True)
    
    # 在正方形区域内随机选择点击位置（边长80，半边长40）
    half_size = int(fishing_size / 2 * 0.7)  # 留点边距
    ...
    auto_radius = auto_btn.get('radius', 30)  # 直径60，半径30
